...
<%--                            <input type="text" class="form-control" name="managerPhone" value="${modelSearch.managerPhone}">--%>
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <table id="tableList" style="margin: 3em 0 0;" class="table table-striped table-bordered
										table-hover">
                    <thead>
<%--                    <tr>--%>
<%--                      <th class="center">--%>
...
<%--                    </c:forEach>--%>
    ...
    <a title="Giao tòa nhà" class="btn btn-xs btn-success" onclick="assingmentBuilding(${tableList.id})">
        <i class="ace-icon glyphicon glyphicon-list"></i>
    </a>
